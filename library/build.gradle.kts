...
mavenPublishing {
    ...
    coordinates(group.toString(), "blocked-cache", version.toString())

    pom {
        name = "BlockedCache"
        description = "Kotlin Multiplatform Mobile framework for optimal code sharing between iOS and Android."
        inceptionYear = "2024"
        url = "https://github.com/Paoapps/BlockedCache"
        licenses {
            license {
                name = "MIT"
        ...
        scm {
            url = "https://github.com/Paoapps/BlockedCache"
            connection = "scm:git:git://github.com/Paoapps/BlockedCache.git"
            developerConnection = "scm:git:ssh://git@github.com/Paoapps/BlockedCache.git"
        }
    }
}
